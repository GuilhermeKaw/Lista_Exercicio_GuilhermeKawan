...
Criar um novo projeto do tipo Console App (.NET)

Copiar os exercícios para o arquivo Program.cs
...
A construção da minha base lógica

Meu primeiro contato com organização de código
...
Utilizar para fins educacionais ou comerciais
